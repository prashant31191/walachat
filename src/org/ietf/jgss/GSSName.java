...
public interface GSSName {
	...
	static final Oid NT_HOSTBASED_SERVICE = new Oid(new int[] { 1, 3, 6, 1, 5,
			6, 2 });

	static final Oid NT_MACHINE_UID_NAME = new Oid(new int[] { 1, 2, 840,
			113554, 1, 2, 1, 2 });

	static final Oid NT_STRING_UID_NAME = new Oid(new int[] { 1, 2, 840,
			113554, 1, 2, 1, 3 });

	static final Oid NT_USER_NAME = new Oid(new int[] { 1, 2, 840, 113554, 1,
			2, 1, 1 });
