...
public class ConnectionConfiguration implements Cloneable {
	...
	public ConnectionConfiguration(String serviceName) {
		...
		final DNSUtil.HostAddress address = DNSUtil
				.resolveXMPPDomain(serviceName);
	...
	/**
	 * Returns the password to use to access the trust store file. It is assumed
	 * that all certificates share the same password in the trust store.
	 * 
	...
	/**
	 * Retuns the path to the trust store file. The trust store file contains
	 * the root certificates of several well known CAs. By default, will attempt
	 * to use the the file located in $JREHOME/lib/security/cacerts.
	 * 
	...
	/**
	 * Returns true if certificates presented by the server are going to be
	 * checked for their validity. By default certificates are not verified.
	 * 
	 * @return true if certificates presented by the server are going to be
	...
	/**
	 * Returns true if certificates presented by the server are going to be
	 * checked for their domain. By default certificates are not verified.
	 * 
	 * @return true if certificates presented by the server are going to be
	 *         checked for their domain.
	 */
	...
	/**
	 * Returns true if self-signed certificates are going to be accepted. By
	...
	/**
	 * Returns true if the whole chain of certificates presented by the server
	 * are going to be checked. By default the certificate chain is not
	 * verified.
	 * 
	 * @return true if the whole chaing of certificates presented by the server
	...
	/**
	 * Returns true if root CA checking is going to be done. By default checking
	 * is disabled.
	 * 
	...
	/**
	 * Sets if certificates presented by the server are going to be checked for
	 * their validity. By default certificates are not verified.
	 * 
	 * @param expiredCertificatesCheckEnabled
	 *            if certificates presented by the server are going to be
	 *            checked for their validity.
	 */
	public void setExpiredCertificatesCheckEnabled(
			boolean expiredCertificatesCheckEnabled) {
	...
	/**
	 * Sets if certificates presented by the server are going to be checked for
	 * their domain. By default certificates are not verified.
	 * 
	 * @param notMatchingDomainCheckEnabled
	 *            if certificates presented by the server are going to be
	 *            checked for their domain.
	 */
	public void setNotMatchingDomainCheckEnabled(
			boolean notMatchingDomainCheckEnabled) {
	 ...
	 *            if self-signed certificates are going to be accepted.
	 */
	...
	/**
	 * Sets the password to use to access the trust store file. It is assumed
	 * that all certificates share the same password in the trust store.
	 * 
	...
	/**
	 * Sets the path to the trust store file. The truststore file contains the
	 * root certificates of several well?known CAs. By default Smack is going to
	 * use the file located in $JREHOME/lib/security/cacerts.
	 * 
	...
	/**
	 * Sets if the whole chain of certificates presented by the server are going
	 * to be checked. By default the certificate chain is not verified.
	 * 
	...
	/**
	 * Sets if root CA checking is going to be done. By default checking is
	 * disabled.
	 * 
	 * @param verifyRootCAEnabled
	 *            if root CA checking is going to be done.
	 */
