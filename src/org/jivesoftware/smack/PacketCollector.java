 ...
 * $RCSfile$
 * $Revision: 12509 $
 * $Date: 2011-06-18 13:18:03 -0500 (Sat, 18 Jun 2011) $
 *
 ...
 * operations on the result queue. So, a PacketCollector is more suitable to use
 * than a {@link PacketListener} when you need to wait for a specific result.
 * <p>
 * 
 ...
 * is retrieved by {@link SmackConfiguration#getPacketCollectorSize()}.
 * 
...
public class PacketCollector {
	...
	private final LinkedList<Packet> resultQueue;
	 ...
	 * 
	 * @param conection
	 *            the connection the collector is tied to.
	 * @param packetFilter
	...
	protected PacketCollector(Connection conection, PacketFilter packetFilter) {
		...
		resultQueue = new LinkedList<Packet>();
	}
	 ...
	 *            determines which packets will be returned by this collector.
	 * @param maxSize
	 *            the maximum number of packets that will be stored in the
	 *            collector.
	 */
	protected PacketCollector(Connection conection, PacketFilter packetFilter,
			int maxSize) {
