 ...
 * Jingle packets.
 * 
 * As Jingle have many transport methods (official and unofficial methods), this
 * abstract class helps us to extends the transport support of the API.
 * 
 * This class must be used with a JingleManager instance in the following way:
 * 
 * JingleManager jingleManager = new JingleManager(xmppConnection, new
...
public abstract class JingleTransportManager {
	 ...
	 * @return
	 */
	public TransportResolver getResolver(JingleSession session)
