...
public class XHTMLText {
	 ...
	 * 
	 * @param level
	 *            the level of the Header. It should be a value between 1 and 3
	 */
	...
	/**
	 * Appends a tag that indicates the end of a new paragraph. This is usually
	 * rendered with two carriage returns, producing a single blank line in
	 ...
	 * @param alt
	 *            the text to show if you don't show the picture
	 * @param height
	 ...
	 */
	public void appendImageTag(String align, String alt, String height,
			String src, String width) {
		final StringBuilder sb = new StringBuilder("<img");
		if (align != null) {
			sb.append(" align=\"");
			sb.append(align);
			sb.append("\"");
	 ...
	 * 
	 * @param style
	 *            the XHTML style of the blockquote
	 */
	public void appendOpenBlockQuoteTag(String style) {
		final StringBuilder sb = new StringBuilder("<blockquote");
		if (style != null) {
			sb.append(" style=\"");
			sb.append(style);
			sb.append("\"");
	...
	/**
	 * Appends a tag that indicates a reference to work, such as a book, report
	 * or web site.
	 * 
	 */
	...
	/**
	 * Appends a tag that indicates a header, a title of a section of the
	 * message.
	 * 
	 * @param level
	 *            the level of the Header. It should be a value between 1 and 3
	 ...
	 * 
	 * @param style
	 *            the style of the inlined quote
	 */
	...
	/**
	 * Appends a tag that creates an ordered list. "Ordered" means that the
	 * order of the items in the list is important. To show this, browsers
	 * automatically number the list.
	 * 
	 * @param style
	 *            the style of the ordered list
	 */
	...
	/**
	 * Appends a tag that indicates the start of a new paragraph. This is
	 * usually rendered with two carriage returns, producing a single blank line
	...
	/**
	 * Appends a tag that indicates text which should be more forceful than
	 * surrounding text.
	 * 
	 */
	...
	/**
	 * Appends a tag that creates an unordered list. The unordered part means
	 * that the items in the list are not in any particular order.
	 * 
	 * @param style
	 *            the style of the unordered list
	 */
