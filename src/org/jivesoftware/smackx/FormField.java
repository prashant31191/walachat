...
public class FormField {
	...
	public static class Option {
		...
		public String toXML() {
			...
			buf.append(">");
			// Add element
			buf.append("<value>").append(StringUtils.escapeForXML(getValue()))
					.append("</value>");
	...
	/**
	 * Creates a new FormField of type FIXED. The fields of type FIXED do not
	 * define a variable name.
	 */
	public FormField() {
		type = FormField.TYPE_FIXED;
	}

	/**
	 * Creates a new FormField with the variable name that uniquely identifies
	 * the field in the context of the form.
	 * 
	 * @param variable
	...
	/**
	 * Adss an available options to the question that the user has in order to
	 * answer the question.
	 * 
	 * @param option
	 *            a new available option for the question.
	 */
	...
	/**
	 * Adds a default values to the question if the question is part of a form
	 * to fill out. Otherwise, adds an answered values to the question.
	 * 
	 * @param newValues
	 *            default values or an answered values of the question.
	 */
	...
	public String toXML() {
		...
		for (final Iterator<String> i = getValues(); i.hasNext();) {
