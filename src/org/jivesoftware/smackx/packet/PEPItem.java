 ...
 * <p>
 * 
 * The 'http://jabber.org/protocol/pubsub#event' namespace is used to publish
 * personal events items from one client to subscribed clients (See XEP-163).
 * 
...
public abstract class PEPItem implements PacketExtension {
	...
	/**
	 * Returns the XML representation of a Personal Event Publish according the
	 * specification.
	 * 
	...
	public String toXML() {
		...
		buf.append("<").append(getElementName()).append(" id=\"").append(id)
				.append("\">");
