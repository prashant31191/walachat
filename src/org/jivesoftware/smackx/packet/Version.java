 ...
 * PacketCollector collector = con.createPacketCollector(new PacketIDFilter(
 * 		versionRequest.getPacketID()));
 * 
...
public class Version extends IQ {
	...
	/**
	 * Returns the natural-language name of the software. This property will
	 * always be present in a result.
	 * 
	...
	/**
	 * Returns the operating system of the queried entity. This property will
	 * always be present in a result.
	 * 
	...
	/**
	 * Returns the specific version of the software. This property will always
	 * be present in a result.
	 * 
	...
	/**
	 * Sets the natural-language name of the software. This message should only
	 * be invoked when parsing the XML and setting the property to a Version
	 * instance.
	 * 
	 * @param name
	...
	/**
	 * Sets the operating system of the queried entity. This message should only
	 * be invoked when parsing the XML and setting the property to a Version
	 * instance.
	 * 
	 * @param os
	 ...
	 * invoked when parsing the XML and setting the property to a Version
	 * instance.
	 * 
	 * @param version
