...
/**
 * An XHTML sub-packet, which is used by XMPP clients to exchange formatted
 * text. The XHTML extension is only a subset of XHTML 1.0.
 * <p>
 * 
 * The following link summarizes the requirements of XHTML IM: <a
 * href="http://www.jabber.org/jeps/jep-0071.html#sect-id2598018">Valid
 * tags</a>.
 * <p>
 * 
 * Warning: this is an non-standard protocol documented by <a
 * href="http://www.jabber.org/jeps/jep-0071.html">JEP-71</a>. Because this is a
...
public class XHTMLExtension implements PacketExtension {
	...
	public String toXML() {
		...
		for (final Iterator<String> i = getBodies(); i.hasNext();) {
			buf.append(i.next());
		}
