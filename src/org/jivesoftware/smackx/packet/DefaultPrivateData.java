...
/**
 * Default implementation of the PrivateData interface. Unless a
 * PrivateDataProvider is registered with the PrivateDataManager class,
 * instances of this class will be returned when getting private data.
 * <p>
 * 
 ...
 * have attributes. In those cases, a custom
 * {@link org.jivesoftware.smackx.provider.PrivateDataProvider} should be used.
 * 
 * @author Matt Tucker
 */
public class DefaultPrivateData implements PrivateData {
	...
	/**
	 * Returns an Iterator for the names that can be used to get values of the
	 * private data.
	 * 
	...
	public String toXML() {
		...
		for (final Iterator<String> i = getNames(); i.hasNext();) {
