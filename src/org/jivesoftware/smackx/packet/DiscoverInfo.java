 ...
 * $RCSfile$
 * $Revision: 12007 $
 * $Date: 2010-12-04 10:28:52 -0600 (Sat, 04 Dec 2010) $
 *
...
public class DiscoverInfo extends IQ {
	...
	/**
	 * Represents the features offered by the item. This information helps
	 * requestors determine what actions are possible with regard to this item
	 * (registration, search, join, etc.) as well as specific feature types of
	...
	/**
	 * Represents the identity of a given XMPP entity. An entity may have many
	 * identities but all the identities SHOULD have the same name.
	 * <p>
	 * 
	 * Refer to <a
	 * href="http://www.jabber.org/registrar/disco-categories.html">Jabber
	 * ::Registrar</a> in order to get the official registry of values for the
	 * <i>category</i> and <i>type</i> attributes.
	 * 
	 */
	public static class Identity {
		...
		/**
		 * Returns the entity's category. To get the official registry of values
		 * for the 'category' attribute refer to <a
		 * href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
		 * 
		...
		/**
		 * Returns the entity's type. To get the official registry of values for
		 * the 'type' attribute refer to <a
		 * href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
		 * 
		...
		/**
		 * Sets the entity's type. To get the official registry of values for
		 * the 'type' attribute refer to <a
		 * href="http://www.jabber.org/registrar/disco-categories.html"
		 * >Jabber::Registrar</a>
		 * 
	...
	/**
	 * Adds a new identity of the requested entity to the discovered
	 * information.
	 * 
	 * @param identity
	...
	/**
	 * Returns true if the specified feature is part of the discovered
	 * information.
	 * 
	 * @param feature
	...
	public boolean containsFeature(String feature) {
		for (final Iterator<Feature> it = getFeatures(); it.hasNext();) {
