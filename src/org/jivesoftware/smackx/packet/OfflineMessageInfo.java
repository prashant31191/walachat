...
/**
 * OfflineMessageInfo is an extension included in the retrieved offline messages
 * requested by the {@link org.jivesoftware.smackx.OfflineMessageManager}. This
 * extension includes a stamp that uniquely identifies the offline message. This
 * stamp may be used for deleting the offline message. The stamp may be of the
...
public class OfflineMessageInfo implements PacketExtension {
	...
	public static class Provider implements PacketExtensionProvider {
		...
		public PacketExtension parseExtension(XmlPullParser parser)
				throws Exception {
			final OfflineMessageInfo info = new OfflineMessageInfo();
			boolean done = false;
			while (!done) {
	 ...
	 * stamp may be used for deleting the offline message. The stamp may be of
	...
	/**
	 * Sets the stamp that uniquely identifies the offline message. This stamp
	 * may be used for deleting the offline message. The stamp may be of the
	 * form UTC timestamps but it is not required to have that format.
	 * 
	 * @param node
