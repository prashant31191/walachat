 ...
 * 'jabber:iq:roster' namespace) is used to send roster items from one client to
 * another. A roster item is sent by adding to the &lt;message/&gt; element an
 * &lt;x/&gt; child scoped by the 'jabber:x:roster' namespace. This &lt;x/&gt;
 * element may contain one or more &lt;item/&gt; children (one for each roster
 * item to be sent).
 * <p>
 * 
 ...
 * <br>
 * &lt;name/&gt; -- A natural-language nickname for the contact. This attribute
 * is optional.
 * <p>
 * 
 * Each &lt;item/&gt; element may also contain one or more &lt;group/&gt;
 * children specifying the natural-language name of a user-specified group, for
 * the purpose of categorizing this contact into one or more roster groups.
 * 
