...
/**
 * Represents extended presence information about roles, affiliations, full
 * JIDs, or status codes scoped by the 'http://jabber.org/protocol/muc#user'
 * namespace.
 * 
...
public class MUCUser implements PacketExtension {
	...
	/**
	 * Represents a rejection to an invitation from another user to a room. The
	 * rejection will be sent to the room which in turn will forward the refusal
	 * to the inviter.
	 * 
	 * @author Gaston Dombiak
	 */
	public static class Decline {
		 ...
		 * (e.g. 'crone1@shakespeare.lit/desktop').
		 * 
	...
	/**
	 * Represents a notification that the room has been destroyed. After a room
	 * has been destroyed, the room occupants will receive a Presence packet of
	 * type 'unavailable' with the reason for the room destruction if provided
	 * by the room owner.
	 * 
	 * @author Gaston Dombiak
	 */
	public static class Destroy {
		...
		/**
		 * Returns the JID of an alternate location since the current room is
		 * being destroyed.
		 * 
	...
	/**
	 * Represents an invitation for another user to a room. The sender of the
	 * invitation must be an occupant of the room. The invitation will be sent
	 * to the room which in turn will forward the invitation to the invitee.
	 * 
	 * @author Gaston Dombiak
	 */
	public static class Invite {
		 ...
		 * 
		 * @param from
		 *            the bare JID of the inviter or, optionally, the room JID.
		 */
		public void setFrom(String from) {
			this.from = from;
		}
	...
	/**
	 * Status code assists in presenting notification messages. The following
	 * link provides the list of existing error codes (@link
	 * http://www.jabber.org/jeps/jep-0045.html#errorstatus).
	 * 
	 * @author Gaston Dombiak
	 */
	public static class Status {
		 ...
		 * The code assists in presenting notification messages.
		 * 
	...
	/**
	 * Returns the rejection to an invitation from another user to a room. The
	 * rejection will be sent to the room which in turn will forward the refusal
	 * to the inviter.
	 * 
	...
	/**
	 * Returns the notification that the room has been destroyed. After a room
	 * has been destroyed, the room occupants will receive a Presence packet of
	 * type 'unavailable' with the reason for the room destruction if provided
	 * by the room owner.
	 * 
	...
	/**
	 * Returns the invitation for another user to a room. The sender of the
	 * invitation must be an occupant of the room. The invitation will be sent
	 * to the room which in turn will forward the invitation to the invitee.
	 * 
	...
	/**
	 * Returns the item child that holds information about roles, affiliation,
	 * jids and nicks.
	 * 
	 * @return an item child that holds information about roles, affiliation,
	 *         jids and nicks.
	 */
	public Item getItem() {
		return item;
	 ...
	 * Password-Protected Room is a room that a user cannot enter without first
	...
	/**
	 * Sets the rejection to an invitation from another user to a room. The
	 * rejection will be sent to the room which in turn will forward the refusal
	 * to the inviter.
	 * 
	 * @param decline
	 *            the rejection to an invitation from another user to a room.
	 */
	...
	/**
	 * Sets the notification that the room has been destroyed. After a room has
	 * been destroyed, the room occupants will receive a Presence packet of type
	 * 'unavailable' with the reason for the room destruction if provided by the
	 * room owner.
	 * 
	 * @param destroy
	...
	/**
	 * Sets the item child that holds information about roles, affiliation, jids
	 * and nicks.
	 * 
	 * @param item
	 ...
	 * 
	 * @param status
	 *            the status which holds a code that assists in presenting
	 *            notification messages.
	 */
