...
/**
 * IQ packet that serves for granting and revoking ownership privileges,
 * granting and revoking administrative privileges and destroying a room. All
 * these operations are scoped by the 'http://jabber.org/protocol/muc#owner'
 * namespace.
 * 
...
public class MUCOwner extends IQ {
	...
	/**
	 * Represents a request to the server to destroy a room. The sender of the
	...
	public static class Item {
		...
		/**
		 * Sets the temporary position or privilege level of an occupant within
		 * a room. The possible roles are "moderator", "participant", and
		 * "visitor" (it is also possible to have no defined role). A role lasts
		 * only for the duration of an occupant's visit to a room.
		 * 
		 * @param role
		 *            the new privilege level of an occupant within a room.
		 */
	...
	/**
	 * Adds an item child that holds information about affiliation, jids and
	 * nicks.
	 * 
	 * @param item
	 *            the item child that holds information about affiliation, jids
	 *            and nicks.
	 */
	...
	/**
	 * Returns a request to the server to destroy a room. The sender of the
	 * request should be the room's owner. If the sender of the destroy request
	 * is not the room's owner then the server will answer a "Forbidden" error.
	 * 
	 ...
	 * should be the room's owner. If the sender of the destroy request is not
	 * the room's owner then the server will answer a "Forbidden" error.
	 * 
	 * @param destroy
	 *            the request to the server to destroy a room.
	 */
