 ...
 * changed, such as the user being kicked, banned, or granted admin permissions.
 * 
...
public interface UserStatusListener {
	 ...
	 * 
	 * @param actor
	 *            the moderator that kicked your user from the room (e.g.
	 *            user@host.org).
	 * @param reason
	 ...
	 * This means that you will no longer be able to kick users, grant and
	 ...
	 * means that you will no longer be able to change defining room features as
	...
	/**
	 * Called when a moderator revokes voice from your user. This means that you
	 * were a participant in the room able to speak and now you are a visitor
	 * that can't send messages to the room occupants.
	 * 
	 */
