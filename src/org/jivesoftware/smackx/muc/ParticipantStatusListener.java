...
public interface ParticipantStatusListener {
	 ...
	 * means that the user will be able to perform administrative functions such
	 * as banning users and edit moderator list.
	 * 
	 * @param participant
	...
	/**
	 * Called when an owner revokes administrator privileges from a user. This
	 * means that the user will no longer be able to perform administrative
	 ...
	 * This means that banned participant will no longer be able to join the
	 * room unless the ban has been removed.
	 * 
	 * @param participant
	 *            the participant that was banned from the room (e.g.
	 *            room@conference.jabber.org/nick).
	 * @param actor
	 *            the administrator that banned the occupant (e.g.
	 *            user@host.org).
	 * @param reason
	...
	/**
	 * Called when a room participant has been kicked from the room. This means
	 * that the kicked participant is no longer participating in the room.
	 * 
	 * @param participant
	 *            the participant that was kicked from the room (e.g.
	 *            room@conference.jabber.org/nick).
	 * @param actor
	 *            the moderator that kicked the occupant from the room (e.g.
	 *            user@host.org).
	 * @param reason
	 *            the reason provided by the actor to kick the occupant from the
	 *            room.
	 */
	public abstract void kicked(String participant, String actor, String reason);

	/**
	 * Called when a room occupant has left the room on its own. This means that
	 * the occupant was neither kicked nor banned from the room.
	 * 
	 * @param participant
	...
	/**
	 * Called when an administrator grants a user membership to the room. This
	 * means that the user will be able to join the members-only room.
	 * 
	 * @param participant
	...
	/**
	 * Called when an administrator revokes a user membership to the room. This
	 * means that the user will not be able to join the members-only room.
	 * 
	 * @param participant
	...
	/**
	 * Called when an administrator grants moderator privileges to a user. This
	 * means that the user will be able to kick users, grant and revoke voice,
	 * invite other users, modify room's subject plus all the partcipants
	 * privileges.
	 * 
	 * @param participant
	 *            the participant that was granted moderator privileges in the
	 ...
	 * This means that the user will no longer be able to kick users, grant and
	 * revoke voice, invite other users, modify room's subject plus all the
	 * partcipants privileges.
	 * 
	 * @param participant
	 *            the participant that was revoked moderator privileges in the
	 *            room (e.g. room@conference.jabber.org/nick).
	 */
	public abstract void moderatorRevoked(String participant);

	/**
	 * Called when a participant changed his/her nickname in the room. The new
	 * participant's nickname will be informed with the next available presence.
	 * 
	 * @param participant
	 *            the participant that was revoked administrator privileges
	 *            (e.g. room@conference.jabber.org/nick).
	...
	/**
	 * Called when an owner grants a user ownership on the room. This means that
	 * the user will be able to change defining room features as well as perform
	...
	/**
	 * Called when an owner revokes a user ownership on the room. This means
	 * that the user will no longer be able to change defining room features as
	 * well as perform all administrative functions.
	 * 
	 * @param participant
	...
	/**
	 * Called when a moderator grants voice to a visitor. This means that the
	 * visitor can now participate in the moderated room sending messages to all
	 * occupants.
	 * 
	 * @param participant
	...
	/**
	 * Called when a moderator revokes voice from a participant. This means that
	 * the participant in the room was able to speak and now is a visitor that
	 * can't send messages to the room occupants.
	 * 
	 * @param participant
