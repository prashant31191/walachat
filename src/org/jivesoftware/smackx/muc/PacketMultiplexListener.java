...
/**
 * The single <code>PacketListener</code> used by each {@link MultiUserChat} for
 * all basic processing of presence, and message packets targeted to that chat.
 * 
...
class PacketMultiplexListener implements PacketListener {
	...
	private static final PacketFilter DECLINES_FILTER = new PacketExtensionFilter(
			"x", "http://jabber.org/protocol/muc#user");

	private final ConnectionDetachedPacketCollector messageCollector;
