...
/**
 * 
 * A listener that is fired anytime a message event request is received. Message
 * event requests are received when the received message includes an extension
 * like this:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * In this example you can see that the sender of the message requests to be
 * notified when the user couldn't receive the message because he/she is
 * offline, the message was delivered or when the receiver of the message is
 * composing a reply.
 * 
...
public interface MessageEventRequestListener {
	...
	/**
	 * Called when a request that the receiver of the message is composing a
	 * reply notification is received.
	 * 
	 * @param from
	...
	/**
	 * Called when a request that the receiver of the message is offline is
	 * received.
	 * 
	 * @param from
	 *            the user that sent the notification.
