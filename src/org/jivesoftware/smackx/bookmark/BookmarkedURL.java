...
/**
 * Respresents one instance of a URL defined using JEP-0048 Bookmark Storage
 * JEP.
 * 
 * @author Derek DeMoro
 */
public class BookmarkedURL implements SharedBookmark {
	...
	public boolean equals(Object obj) {
		...
		final BookmarkedURL url = (BookmarkedURL) obj;
		return url.getURL().equalsIgnoreCase(URL);
	}

	/**
	 * Returns the name representing the URL (eg. Jive Software). This can be
	 * used in as a label, or identifer in applications.
	 * 
