...
public final class FloatingPointParser {
	...
	private static StringExponentPair initialParse(String s, int length) {
		...
		if (length > MAX_DIGITS && e < APPROX_MIN_MAGNITUDE) {
			final int d = Math.min(APPROX_MIN_MAGNITUDE - e, length - 1);
	 ...
	 * represents and multiplying by 10 raised to the power of the exponent.
	 * Returns the closest double value to the real number
	 * 
	 * @param s
	 *            the String that will be parsed to a floating point
	 * @param e
	...
	public static double parseDouble(String s) {
		...
		final StringExponentPair info = initialParse(s, length);
	 ...
	 * floating point number by taking the positive integer the String
	 * represents and multiplying by 10 raised to the power of the exponent.
	 * Returns the closest float value to the real number
	 * 
	 * @param s
	 *            the String that will be parsed to a floating point
	 * @param e
