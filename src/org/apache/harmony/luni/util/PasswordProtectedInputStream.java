...
public class PasswordProtectedInputStream extends FilterInputStream {
	...
	private final byte[] password; // Password to use to decrypt the input bytes
	 ...
	 * 
	 * @param in
	 *            The actual input stream where to read the bytes from.
	 * @param password
	 *            The password bytes to use to decrypt the input bytes
	 */
