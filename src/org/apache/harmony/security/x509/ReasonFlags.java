 ...
 * following part of X.509 CRL (as specified in RFC 3280 - Internet X.509 Public
...
public class ReasonFlags {
	 ...
	 */
	static final String[] REASONS = { "unused", //$NON-NLS-1$
	 ...
	 */
	public static final ASN1BitString ASN1 = new ASN1BitString.ASN1NamedBitList(
			REASONS.length) {
		@Override
