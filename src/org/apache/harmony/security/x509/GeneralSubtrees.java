 ...
 * GeneralSubtrees structure which is a part of X.509 certificate: (as specified
...
public class GeneralSubtrees {
	...
	public static final ASN1Type ASN1 = new ASN1SequenceOf(GeneralSubtree.ASN1) {
		...
		@Override
		public List<GeneralSubtree> getValues(Object object) {
			final GeneralSubtrees gss = (GeneralSubtrees) object;
			return (gss.generalSubtrees == null) ? new ArrayList<GeneralSubtree>()
					: gss.generalSubtrees;
		}
	};
	...
	public GeneralSubtrees addSubtree(GeneralSubtree subtree) {
		...
		if (generalSubtrees == null) {
			generalSubtrees = new ArrayList<GeneralSubtree>();
		}
