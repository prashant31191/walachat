...
/**
 * The class encapsulates the ASN.1 DER encoding/decoding work with the X.509
 * CRL. Its ASN notation is as follows (as specified in RFC 3280 - Internet
...
public class CertificateList {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new CertificateList((TBSCertList) values[0],
					(AlgorithmIdentifier) values[1],
					((BitString) values[2]).bytes, // FIXME keep as BitString
													// object
					in.getEncoded());
		}
		...
		protected void getValues(Object object, Object[] values) {
			...
			final CertificateList certlist = (CertificateList) object;
