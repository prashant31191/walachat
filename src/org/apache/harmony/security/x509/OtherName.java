...
/**
 * The class encapsulates the ASN.1 DER encoding/decoding work with OtherName
 * structure which is a subpart of GeneralName (as specified in RFC 3280 -
...
public class OtherName {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected void getValues(Object object, Object[] values) {
			...
			final OtherName on = (OtherName) object;
