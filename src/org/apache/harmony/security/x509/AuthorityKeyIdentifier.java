...
/**
 * The class encapsulates the ASN.1 DER encoding/decoding work with Authority
 * Key Identifier Extension (OID = 2.5.29.35). (as specified in RFC 3280 -
...
public class AuthorityKeyIdentifier extends ExtensionValue {
	...
	public static AuthorityKeyIdentifier decode(byte[] encoding)
			throws IOException {
		final AuthorityKeyIdentifier aki = (AuthorityKeyIdentifier) ASN1
				.decode(encoding);
	...
	public static final ASN1Type ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected void getValues(Object object, Object[] values) {
			...
			final AuthorityKeyIdentifier akid = (AuthorityKeyIdentifier) object;
