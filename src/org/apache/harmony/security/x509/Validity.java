...
/**
 * The class encapsulates the ASN.1 DER encoding/decoding work with Validity
 * structure which is the part of X.509 certificate (as specified in RFC 3280 -
...
public class Validity {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected void getValues(Object object, Object[] values) {
			...
			final Validity validity = (Validity) object;
