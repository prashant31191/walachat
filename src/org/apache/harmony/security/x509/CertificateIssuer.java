...
/**
 * CRL Entry's Certificate Issuer Extension (OID = 2.5.29.29). It is a CRL entry
 * extension and contains the GeneralNames describing the issuer of revoked
 * certificate. Its ASN.1 notation is as follows:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * (as specified in RFC 3280) In java implementation it is presumed that
 * GeneralNames consist of one element and its type is directoryName.
 */
public class CertificateIssuer extends ExtensionValue {
	...
	public static final ASN1Type ASN1 = new ASN1Sequence(
			new ASN1Type[] { GeneralName.ASN1 }) {
		@Override
		public Object getDecodedObject(BerInputStream in) {
			return ((Name) ((GeneralName) ((Object[]) in.content)[0]).getName())
					.getX500Principal();
		}
