...
public class ExtendedKeyUsage extends ExtensionValue {
	...
	public static final ASN1Type ASN1 = new ASN1SequenceOf(new ASN1Oid() {
		...
		public Object getDecodedObject(BerInputStream in) throws IOException {
			final int[] oid = (int[]) super.getDecodedObject(in);
	...
	/**
	 * Creates an object on the base of list of integer arrays representing key
	 * purpose IDs.
	 */
	...
	/**
	 * Returns the list of string representation of OIDs corresponding to key
	 * purpose IDs.
	 */
