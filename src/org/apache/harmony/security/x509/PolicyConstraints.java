 ...
 * PolicyConstraints structure which is a part of X.509 certificate (as
...
public class PolicyConstraints extends ExtensionValue {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new PolicyConstraints(requireExplicitPolicy,
					inhibitPolicyMapping, in.getEncoded());
		}

		@Override
		protected void getValues(Object object, Object[] values) {

			final PolicyConstraints pc = (PolicyConstraints) object;
	 ...
	 * TODO
	 * 
	 * @param requireExplicitPolicy
	 *            : GeneralSubtrees
	 * @param inhibitPolicyMapping
	 *            : GeneralSubtrees
	 */
	...
	public PolicyConstraints(byte[] encoding) throws IOException {
		super(encoding);
		final PolicyConstraints pc = (PolicyConstraints) ASN1.decode(encoding);
		requireExplicitPolicy = pc.requireExplicitPolicy;
