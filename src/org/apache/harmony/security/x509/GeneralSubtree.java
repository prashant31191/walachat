 ...
 * GeneralSubtree structure which is a part of X.509 certificate: (as specified
...
public class GeneralSubtree {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			GeneralName.ASN1, new ASN1Implicit(0, ASN1Integer.getInstance()),
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new GeneralSubtree((GeneralName) values[0],
					ASN1Integer.toIntValue(values[1]), maximum);
		}

		@Override
		protected void getValues(Object object, Object[] values) {

			final GeneralSubtree gs = (GeneralSubtree) object;
