 ...
 * Algorithm Identifier which is a part of X.509 certificate (as specified in
...
public class AlgorithmIdentifier {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected void getValues(Object object, Object[] values) {
			...
			final AlgorithmIdentifier aID = (AlgorithmIdentifier) object;
	...
	public boolean equals(Object ai) {
		...
		final AlgorithmIdentifier algid = (AlgorithmIdentifier) ai;
		return (algorithm.equals(algid.algorithm))
				&& ((parameters == null) ? algid.parameters == null : Arrays
						.equals(parameters, algid.parameters));
	}
	...
	/**
	 * Returns the name of the algorithm corresponding to its OID. If there is
	 * no the such correspondence, algorithm OID is returned.
	 * 
	 * @return algorithm
	 */
