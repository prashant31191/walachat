...
/**
 * The class encapsulates the ASN.1 DER encoding/decoding work with the CRL
 * Distribution Points which is the part of X.509 Certificate (as specified in
...
public class CRLDistributionPoints extends ExtensionValue {
	...
	public static CRLDistributionPoints decode(byte[] encoding)
			throws IOException {
		final CRLDistributionPoints cdp = (CRLDistributionPoints) ASN1
				.decode(encoding);
		return cdp;
	}

	private final List distributionPoints;
	...
	public static final ASN1Type ASN1 = new ASN1SequenceOf(
		...
		public Collection getValues(Object object) {
			final CRLDistributionPoints dps = (CRLDistributionPoints) object;
	...
	public void dumpValue(StringBuffer buffer, String prefix) {
		...
		int number = 0;
		for (final Iterator it = distributionPoints.iterator(); it.hasNext();) {
