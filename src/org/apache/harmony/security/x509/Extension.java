 ...
 * Extension part of X.509 certificate (as specified in RFC 3280 - Internet
...
public class Extension {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			ASN1Oid.getInstance(), ASN1Boolean.getInstance(),
			new ASN1OctetString() {
				@Override
				public Object getDecodedObject(BerInputStream in)
					...
					return new Object[] { super.getDecodedObject(in),
							in.getEncoded() };
				}
			} }) {
		{
		...
		protected Object getDecodedObject(BerInputStream in) throws IOException {
			...
			final int[] oid = (int[]) values[0];
			final byte[] extnValue = (byte[]) ((Object[]) values[2])[0];
			final byte[] rawExtnValue = (byte[]) ((Object[]) values[2])[1];
			...
			return new Extension((int[]) values[0],
					((Boolean) values[1]).booleanValue(), extnValue,
					rawExtnValue, in.getEncoded(), decodedExtValue);
		}

		@Override
		protected void getValues(Object object, Object[] values) {

			final Extension ext = (Extension) object;
	...
	private Extension(int[] extnID, boolean critical, byte[] extnValue,
		...
		extnValueObject = decodedExtValue;
		valueDecoded = (decodedExtValue != null);
	}
	...
	public Extension(String extnID, boolean critical,
		...
		valueDecoded = true;
		extnValue = extnValueObject.getEncoded();
	}
	...
	private void decodeExtensionValue() throws IOException {
		...
		if (oidEquals(extnID, SUBJ_KEY_ID)) {
			...
			extnValueObject = new AlternativeName(AlternativeName.SUBJECT,
					extnValue);
	...
	public boolean equals(Object ext) {
		...
		final Extension extn = (Extension) ext;
	...
	/**
	 * Returns the raw (undecoded octet string) value of extnValue field of the
	 * structure.
	 * 
	 * @return rawExtnValue
	 */
	...
	@Override
	public int hashCode() {
		return (extnID.hashCode() * 37 + (critical ? 1 : 0)) * 37
				+ extnValue.hashCode();
	}
}
