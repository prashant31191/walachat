 ...
 * following certificate extension (OID: 2.5.29.16) (as specified in RFC 3280 -
...
public class PrivateKeyUsagePeriod {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new PrivateKeyUsagePeriod((Date) values[0],
					(Date) values[1], in.getEncoded());
		}

		@Override
		protected void getValues(Object object, Object[] values) {

			final PrivateKeyUsagePeriod pkup = (PrivateKeyUsagePeriod) object;
	...
	// @param encoding: byte[]
	//
	private PrivateKeyUsagePeriod(Date notBeforeDate, Date notAfterDate,
			byte[] encoding) {
