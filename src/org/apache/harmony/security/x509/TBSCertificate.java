 ...
 * TBSCertificate structure which is the part of X.509 certificate (as specified
...
public class TBSCertificate {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			...
			ASN1Integer.getInstance(), AlgorithmIdentifier.ASN1, Name.ASN1,
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			final boolean[] issuerUniqueID = (values[7] == null) ? null
					: ((BitString) values[7]).toBooleanArray();
			final boolean[] subjectUniqueID = (values[8] == null) ? null
					: ((BitString) values[8]).toBooleanArray();
			return new TBSCertificate(ASN1Integer.toIntValue(values[0]),
					new BigInteger((byte[]) values[1]),
					(AlgorithmIdentifier) values[2], (Name) values[3],
					(Validity) values[4], (Name) values[5],
					(SubjectPublicKeyInfo) values[6], issuerUniqueID,
					subjectUniqueID, (Extensions) values[9], in.getEncoded());
		}

		@Override
		protected void getValues(Object object, Object[] values) {
			final TBSCertificate tbs = (TBSCertificate) object;
	...
	/**
	 * Constructs the instance of TBSCertificate without optional fields
	...
	public TBSCertificate(int version, BigInteger serialNumber,
			AlgorithmIdentifier signature, Name issuer, Validity validity,
			Name subject, SubjectPublicKeyInfo subjectPublicKeyInfo) {
	...
	public void dumpValue(StringBuffer buffer) {
		...
		if (issuerUniqueID != null) {
			buffer.append("\n  Issuer Id: "); //$NON-NLS-1$
			for (final boolean element : issuerUniqueID) {
				buffer.append(element ? '1' : '0');
			}
		}
		if (subjectUniqueID != null) {
			buffer.append("\n  Subject Id: "); //$NON-NLS-1$
			for (final boolean element : subjectUniqueID) {
				buffer.append(element ? '1' : '0');
			}
		}
		if (extensions != null) {
