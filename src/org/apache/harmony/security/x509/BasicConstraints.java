...
public class BasicConstraints extends ExtensionValue {
	...
	public static final ASN1Type ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected void getValues(Object object, Object[] values) {
			final Object[] vals = (Object[]) object;
			values[0] = vals[0];
	...
	// encoding provided
	/**
	 * Creates the extension object on the base of the values of fields of the
	 * structure..
	 */
	...
	public BasicConstraints(byte[] encoding) throws IOException {
		super(encoding);
		final Object[] values = (Object[]) ASN1.decode(encoding);
	...
	public byte[] getEncoded() {
		if (encoding == null) {
			encoding = ASN1.encode(new Object[] { Boolean.valueOf(cA),
