 ...
 * AccessDescription which is a part of X.509 framework (as specified in RFC
...
public class AccessDescription {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			ASN1Oid.getInstance(), GeneralName.ASN1 }) {
		...
		protected void getValues(Object object, Object[] values) {
			...
			final AccessDescription ad = (AccessDescription) object;
