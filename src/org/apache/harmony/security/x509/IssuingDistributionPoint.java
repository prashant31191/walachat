...
public class IssuingDistributionPoint extends ExtensionValue {
	...
	public static IssuingDistributionPoint decode(byte[] encoding)
			throws IOException {
		final IssuingDistributionPoint idp = (IssuingDistributionPoint) ASN1
				.decode(encoding);
	...
	private final ReasonFlags onlySomeReasons;
	...
	public static final ASN1Type ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			final IssuingDistributionPoint idp = new IssuingDistributionPoint(
		...
		protected void getValues(Object object, Object[] values) {
			final IssuingDistributionPoint idp = (IssuingDistributionPoint) object;
