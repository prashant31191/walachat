...
/**
 * This class implements the values of Subject Alternative Name (OID is
 * 2.5.29.17) and Issuer Alternative Name extensions (OID is 2.5.29.18).<br>
 * For more information about these extensions see RFC 3280 at
...
public class AlternativeName extends ExtensionValue {
	 ...
	 * 
	 * @param which
	 *            specifies which alternative names are given (Subject's or
	 *            Issuer's)
	 */
	public AlternativeName(boolean which, byte[] encoding) throws IOException {
		super(encoding);
		this.which = which;
		alternativeNames = (GeneralNames) GeneralNames.ASN1.decode(encoding);
	}
	...
	/**
	 * Returns the list of alternative names. The list is in the collection of
	 * pairs:<br>
