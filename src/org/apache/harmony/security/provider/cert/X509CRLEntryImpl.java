...
/**
 * Implementation of X509CRLEntry. It wraps the instance of
 * org.apache.harmony.security.x509.TBSCertList.RevokedCertificate obtained
 * during the decoding of TBSCertList substructure of the CertificateList
 * structure which is an X.509 form of CRL. (see RFC 3280 at
 * http://www.ietf.org/rfc/rfc3280.txt) Normally the instances of this class are
 * constructed by involving X509CRLImpl object.
 * 
...
public class X509CRLEntryImpl extends X509CRLEntry {
	 ...
	 * <code>TBSCertList.RevokedCertificate</code> object and information about
	 * the issuer of revoked certificate. If specified issuer is null, it is
	 * supposed that issuer of the revoked certificate is the same as for
	 * involving CRL.
	 */
	public X509CRLEntryImpl(TBSCertList.RevokedCertificate rcert,
			X500Principal issuer) {
		this.rcert = rcert;
		extensions = rcert.getCrlEntryExtensions();
		this.issuer = issuer;
	}
	...
	/**
	 * @see java.security.cert.X509CRLEntry#getCertificateIssuer() method
	...
	/**
	 * @see java.security.cert.X509CRLEntry#getEncoded() method documentation
	 *      for more info
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509CRLEntry#getRevocationDate() method
	 *      documentation for more info
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509CRLEntry#getSerialNumber() method
	 *      documentation for more info
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509CRLEntry#hasExtensions() method documentation
	 *      for more info
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509CRLEntry#toString() method documentation for
	 *      more info
	 */
	@Override
