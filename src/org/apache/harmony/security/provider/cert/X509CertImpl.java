...
/**
 * This class is an implementation of X509Certificate. It wraps the instance of
 * org.apache.harmony.security.x509.Certificate built on the base of provided
 * ASN.1 DER encoded form of Certificate structure (as specified in RFC 3280
...
public class X509CertImpl extends X509Certificate {
	...
	/**
	 * Constructs the instance on the base of ASN.1 encoded form of X.509
	 * certificate provided via array of bytes.
	 * 
	 * @param encoding
	 *            byte array containing ASN.1 encoded form of certificate.
	 * @throws IOException
	 *             if some decoding problems occur.
	 */
	...
	/**
	 * Constructs the instance on the base of existing Certificate object to be
	 * wrapped.
	 */
	public X509CertImpl(Certificate certificate) {
		this.certificate = certificate;
		// cache the values of TBSCertificate and Extensions
		tbsCert = certificate.getTbsCertificate();
		extensions = tbsCert.getExtensions();
	}

	/**
	 * Constructs the instance on the base of ASN.1 encoded form of X.509
	 * certificate provided via stream parameter.
	 * 
	 * @param in
	 *            input stream containing ASN.1 encoded form of certificate.
	...
	public X509CertImpl(InputStream in) throws CertificateException {
		try {
			...
			certificate = (Certificate) Certificate.ASN1.decode(in);
			// cache the values of TBSCertificate and Extensions
			tbsCert = certificate.getTbsCertificate();
			extensions = tbsCert.getExtensions();
	...
	/**
	 * @see java.security.cert.X509Certificate#checkValidity() method
	...
	/**
	 * @see java.security.cert.X509Certificate#checkValidity(Date) method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getBasicConstraints() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.Certificate#getEncoded() method documentation for
	 *      more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getExtendedKeyUsage() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getIssuerDN() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getIssuerUniqueID() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getIssuerX500Principal() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getKeyUsage() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getNotAfter() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getNotBefore() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.Certificate#getPublicKey() method documentation
	...
	/**
	 * @see java.security.cert.X509Certificate#getSerialNumber() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSigAlgName() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSigAlgOID() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSigAlgParams() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSignature() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSubjectDN() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSubjectUniqueID() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getSubjectX500Principal() method
	 *      documentation for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.X509Certificate#getTBSCertificate() method
	 *      documentation for more information.
	 */
	@Override
	public byte[] getTBSCertificate() throws CertificateEncodingException {
		...
		final byte[] result = new byte[tbsCertificate.length];
		System.arraycopy(tbsCertificate, 0, result, 0, tbsCertificate.length);
		return result;
	}

	/**
	 * @see java.security.cert.X509Certificate#getVersion() method documentation
	 *      for more information.
	 */
	@Override
	...
	/**
	 * @see java.security.cert.Certificate#toString() method documentation for
	 *      more information.
	 */
	@Override
	 ...
	 * 
	 * @see java.security.cert.Certificate#verify(PublicKey) method
	 *      documentation for more information.
	 */
	@Override
	 ...
	 * Verifies the signature of the certificate.
	 * 
	 * @see java.security.cert.Certificate#verify(PublicKey,String) method
	 *      documentation for more information.
	 */
	@Override
