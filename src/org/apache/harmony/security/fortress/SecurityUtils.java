...
public final class SecurityUtils {
	 ...
	 * The method may return null - for the very first thread created by the VM
	 * which does not have inherited context.<br>
	...
	public static AccessControlContext getContext(Thread thread)
		...
		/*
		 * Class cl = VMStack.getCallerClass(0); if (cl !=
		 * AccessController.class) { throw new
		 * SecurityException("You ["+cl+"] do not have access to this resource."
		 * ); }
		 */
	 ...
	 * 
	 * @throws SecurityException
	 *             if a context for the passed <code>thread</code> already
	 *             exists in the map.
	 * @throws NullPointerException
	 *             if thread is null
	 * @throws Error
	 *             if context is null AND if null context is already stored in
	 *             the map
	 */
