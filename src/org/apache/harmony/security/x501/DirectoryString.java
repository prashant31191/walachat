 ...
 * DirectoryString structure (as specified in RFC 3280 - Internet X.509 Public
...
public class DirectoryString {
	...
	public static final ASN1Choice ASN1 = new ASN1Choice(new ASN1Type[] {
			ASN1StringType.TELETEXSTRING, ASN1StringType.PRINTABLESTRING,
			ASN1StringType.UNIVERSALSTRING, ASN1StringType.UTF8STRING,
