 ...
 * 
 * @see http 
 *      ://www.itu.int/ITU-T/asn1/database/itu-t/x/x501/2001/InformationFramework
 *      .html
 */
...
public class Attributes {
	 ...
	 * 
	 * Attribute ::= SEQUENCE { type AttributeType, values SET SIZE (0..MAX) OF
	 * AttributeValue }
	 * 
	...
	public static ASN1Sequence getASN1(InformationObjectSet set) {
		final ASN1OpenType.Id id = new ASN1OpenType.Id();
		final ASN1OpenType any = new ASN1OpenType(id, set);
