...
public class ASN1Oid extends ASN1Primitive {
	 ...
	 * 
	 * This implementation works with encoding that is mapped to
	 ...
	 * to create a custom ASN.1 Object Identifier type. To get a default
	 * implementation it is recommended to use getInstance() method.
	 */
	public ASN1Oid() {
		super(TAG_OID);
	}
	...
	public Object getDecodedObject(BerInputStream in) throws IOException {
		...
		final int[] oid = new int[oidElement];
