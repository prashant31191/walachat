...
public class ASN1Integer extends ASN1Primitive {
	 ...
	 * byte array in two's-complement notation.
	 * 
	 ...
	 * 
	 * @param decoded
	 *            a decoded object corresponding to {@link #asn1 this type}
	 ...
	 * to create a custom ASN.1 Integer type. To get a default implementation it
	 * is recommended to use getInstance() method.
	 */
	public ASN1Integer() {
		super(TAG_INTEGER);
	}
	...
	public Object getDecodedObject(BerInputStream in) throws IOException {
		final byte[] bytesEncoded = new byte[in.length];
