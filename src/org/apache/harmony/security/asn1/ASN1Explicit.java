...
public final class ASN1Explicit extends ASN1Constructured {
	...
	/**
	 * Constructs explicitly tagged ASN.1 type with context-specific tag class
	 * and specified tag number.
	 * 
	 * @param tagNumber
	 *            - ASN.1 tag number
	 * @param type
	 *            - ASN.1 type to be tagged
	...
	public Object decode(BerInputStream in) throws IOException {
		if (constrId != in.tag) {
			throw new ASN1Exception(Messages.getString("security.13F", //$NON-NLS-1$
