...
/**
 * This abstract class represents ASN.1 type that is a collection of ASN.1
 * types.
 * 
...
public abstract class ASN1TypeCollection extends ASN1Constructured {
	 ...
	 *            - ASN.1 tag number
	 * @param type
	 *            - a collection of one or more ASN.1 types.
	...
	public ASN1TypeCollection(int tagNumber, ASN1Type[] type) {
		...
		this.type = type;
		OPTIONAL = new boolean[type.length];
		DEFAULT = new Object[type.length];
	}

	/**
	 * Provides an object's values to be encoded
	 * 
	 * Derived classes should override this method to provide encoding for a
	...
	protected void getValues(Object object, Object[] values) {
		throw new RuntimeException(Messages.getString(
				"security.101", getClass().getName())); //$NON-NLS-1$
	}

	/**
	 * Sets a default value for a collection component. The component also
	 * became an optional component.
	 * 
	 * @param object
	 *            - a component's default value
	 * @param index
