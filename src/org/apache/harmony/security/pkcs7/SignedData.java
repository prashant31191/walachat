 ...
 * IMPLICIT ExtendedCertificatesAndCertificates OPTIONAL, crls [1] IMPLICIT
...
public class SignedData {
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			ASN1Integer.getInstance(), new ASN1SetOf(AlgorithmIdentifier.ASN1),
			ContentInfo.ASN1,
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new SignedData(ASN1Integer.toIntValue(values[0]),
					(List) values[1], (ContentInfo) values[2],
					(List) values[3], (List) values[4], (List) values[5]);
		}

		@Override
		protected void getValues(Object object, Object[] values) {
			final SignedData sd = (SignedData) object;
	...
	public SignedData(int version, List digestAlgorithms,
			ContentInfo contentInfo, List<Certificate> certificates, List crls,
			List signerInfos) {
