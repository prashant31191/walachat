 ...
 * (http://www.ietf.org/rfc/rfc2315.txt): authenticatedAttributes is a set of
 * attributes that are signed (i.e., authenticated) by the signer
 */
class AuthenticatedAttributes {
	private byte[] encoding;
	private final List authenticatedAttributes;

	public static final ASN1SetOf ASN1 = new ASN1SetOf(
