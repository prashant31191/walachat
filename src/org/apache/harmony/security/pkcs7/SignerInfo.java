 ...
 * IssuerAndSerialNumber, digestAlgorithm DigestAlgorithmIdentifier,
 * authenticatedAttributes [0] IMPLICIT Attributes OPTIONAL,
 * digestEncryptionAlgorithm DigestEncryptionAlgorithmIdentifier,
 * encryptedDigest EncryptedDigest, unauthenticatedAttributes [1] IMPLICIT
 * Attributes OPTIONAL }
 * 
 */
public class SignerInfo {
	...
	public static final ASN1Sequence ISSUER_AND_SERIAL_NUMBER = new ASN1Sequence(
			new ASN1Type[] { Name.ASN1, // issuer
					ASN1Integer.getInstance(), // serialNumber
			}) {
		// method to encode
		@Override
		public void getValues(Object object, Object[] values) {
			final Object[] issAndSerial = (Object[]) object;
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
			...
			ISSUER_AND_SERIAL_NUMBER, AlgorithmIdentifier.ASN1, // digestAlgorithm
			...
			new ASN1Implicit(1, new ASN1SetOf(AttributeTypeAndValue.ASN1)),// unauthenticatedAttributes
	}) {
		{
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new SignerInfo(ASN1Integer.toIntValue(values[0]),
					(Object[]) values[1], (AlgorithmIdentifier) values[2],
					(AuthenticatedAttributes) values[3],
					(AlgorithmIdentifier) values[4], (byte[]) values[5],
					(List) values[6]);
		}

		@Override
		protected void getValues(Object object, Object[] values) {
			final SignerInfo si = (SignerInfo) object;
	...
	public SignerInfo(int version, Object[] issuerAndSerialNumber,
			AlgorithmIdentifier digestAlgorithm,
			AuthenticatedAttributes authenticatedAttributes,
			AlgorithmIdentifier digestEncryptionAlgorithm,
			byte[] encryptedDigest, List unauthenticatedAttributes) {
		this.version = version;
		issuer = ((Name) issuerAndSerialNumber[0]).getX500Principal();
		serialNumber = BigInteger.valueOf(ASN1Integer
				.toIntValue(issuerAndSerialNumber[1]));
