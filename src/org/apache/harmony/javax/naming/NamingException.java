 ...
 * </p>
 * <p>
 * Multithreaded access to a <code>NamingException</code> instance is only safe
 * when client code locks the object first.
 * </p>
 */
public class NamingException extends Exception {
	 ...
	 * <code>Name</code> held as the remaining name. The <code>Name</code> n may
	 * be null or may be empty.
	 * 
	 * @param n
	 *            the name to append to the remaining name.
	 * @throws IllegalArgumentException
	 *             if appending the supplied <code>Name</code> n causes the name
	 *             to become invalid.
	 */
	...
	/**
	 * Sets the exception that caused this <code>NamingException</code>. It may
	 * be null. Ignore the supplied parameter if it is actually this exception.
	 * 
	 * @param t
