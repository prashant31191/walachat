 ...
 * proceed further. If unsuccessful, the <code>CannotProceedException</code> can
 * be thrown by the service provider so that the JNDI application can handle it
 * and take appropriate action.
 * </p>
 * <p>
 * Multithreaded access to a single <code>CannotProceedException</code> instance
 * is only safe when client code uses appropriate synchronization and locking.
 * </p>
 * 
 */
public class CannotProceedException extends NamingException {
	 ...
	 * is relative to the context in <code>altNameCtx</code>. This field may be
	 * null and is initially null. This field should be accessed and modified
	 ...
	 * default initial context. This field should be accessed and modified using
	 * only <code>getAltNameCtx</code> and <code>setAltNameCtx</code>.
	 */
	 ...
	 * that was specified in a <code>Context.rename</code> operation and may be
	 * used to continue the <code>rename</code> operation. This field may be
	 * null and is initially null. This field should be accessed and modified
	...
	/**
	 * Constructs a <code>CannotProceedException</code> object. All unspecified
	 ...
	 * optionally specified <code>String</code> parameter containing a detailed
	 * explanation message. The <code>String</code> parameter may be null. All
	 ...
	 * @see org.apache.harmony.javax.naming.spi.ObjectFactory#getObjectInstance(Object,
	...
	/**
	 * Retrieves the value of the protected field <code>environment</code> which
	 * may be null.
	 * 
