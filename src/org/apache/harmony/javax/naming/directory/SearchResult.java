...
public class SearchResult extends Binding {
	 ...
	 * 
	 * @param s
	 *            the name of this result. <code>s</code> should be relative to
	 *            the target context for the search that produces this result.
	 * @param o
	...
	/**
	 * Creates a new instance of <code>SearchResult</code> with name
	 * <code>s</code>, bound object <code>o</code>, an <code>attributes</code>
	 * and a boolean <code>flag</code>
	 * 
	 * @param s
	 *            the name of this result. A true value of <code>flag</code>
	 *            means <code>s</code> is relative to the target context of the
	 *            search that produces this result. A false value of
	 *            <code>flag</code> means that <code>s</code> is a URL string.
	 * @param o
	 *            bound object of this result. The class of <code>o</code> is
	 *            the value that will be returned by
	 *            <code>Binding.getClassName()</code> for this search result,
	...
	/**
	 * Creates a new instance of <code>SearchResult</code> with name
	 * <code>s</code>, class name <code>s1</code> bound object <code>o</code>
	 * and an <code>attributes</code>
	 * 
	 * @param s
	 *            the name of this result. <code>s</code> should be relative to
	 *            the target context for the search that produces this result.
	 ...
	 *            class of the bound object <code>o</code>. Passing a null value
	 *            for <code>s1</code> will not stop
	 *            <code>Binding.getClassName()</code> returning the name of the
	 *            class of <code>o</code>.
	 * @param o
	 *            bound object of this result. The class of <code>o</code> is
	 *            the value that will be returned by
	 *            <code>Binding.getClassName()</code> for this search result,
	 ...
	 * Creates a new instance of <code>SearchResult</code> with name
	 * <code>s</code>, class name <code>s1</code> bound object <code>o</code> ,
	 * an <code>attributes</code> and a boolean <code>flag</code>
	 * 
	 * @param s
	 *            the name of this result. A true value of <code>flag</code>
	 *            means <code>s</code> is relative to the target context of the
