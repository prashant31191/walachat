...
public interface Attributes extends Cloneable, Serializable {
	 ...
	 * insensitive if <code>isCaseIgnored()</code> is true. The return value is
	 ...
	 * 
	 */
	NamingEnumeration<? extends org.apache.harmony.javax.naming.directory.Attribute> getAll();
	 ...
	 * the return value is <code>null</code>. The case of the ID is ignored if
	 * <code>isCaseIgnored()</code> is true.
	 * 
	 * @param id
