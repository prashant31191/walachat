 ...
 * </p>
 * <p>
 * The semantics of a name in a <code>DirContext</code> is exactly equivalent to
 * that of a name in a regular naming <code>Context</code>.
 * </p>
 * 
 ...
 * a lookup on that name in the <em>parent</em> <code>DirContext</code> followed
 * by application of the operation on the parent <code>DirContext</code>
 * providing the name as an argument. Think of this as the attributes being
 * stored in the parent context.
 * <p>
 ...
 * <em>Exceptions</em>
 * <p>
 * Any method may throw a <code>NamingException</code> (or subclass) as defined
 * by the exception descriptions.
 * </p>
 */
public interface DirContext extends Context {
	...
	/**
	 * Binds a <code>Name</code> to an <code>Object</code> in this directory to
	 * produce a binding.
	 * 
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Note that null is not a valid value for <code>name</code>. Neither is the
	 * empty <code>Name</code> because this is reserved to refer to the context.
	 * </p>
	 * <p>
	 ...
	 * an <code>InvalidAttributesException</code>.
	 * </p>
	 * <p>
	...
	/**
	 * Gets the attributes for <code>name</code> that match the strings in array
	 * <code>as</code>.
	 * <p>
	...
	/**
	 * Gets the attributes for name represented by <code>s</code> that match the
	 * strings in array <code>as</code>.
	 * 
	 * @param s
	 *            representative of name to be searched for attributes
	 * @param as
	 *            the array of strings to match attributes
	 * @return all attributes for name represented by <code>s</code> that match
	...
	/**
	 * Gets the class definition for name represented by <code>s</code> from its
	 * schema.
	 * 
	 * @param s
	 ...
	 * null but <code>obj</code> is an instance of <code>DirContext</code> then
	 * the attributes of <code>obj</code> become the only attributes of the
	 * binding. If the <code>attributes</code> parameter is null and
	 * <code>obj</code> is not an instance of <code>DirContext</code> then any
	 * attributes of the previous binding remain.
	 * </p>
	 * <p>
	 ...
	 * are selected and all attributes are returned for selected objects.
	 * </p>
	 * <p>
	 * This method throws any <code>NamingException</code> that occurs.
	 * </p>
	 ...
	 * for any objects that have attributes that match the
	 * <code>attributes</code> parameter.
	 * 
	 * <p>
	 * It uses default <code>SearchControls</code>. An object is selected if it
	 * has every attribute in the <code>attributes</code> parameter, regardless
	 * of whether it has extra attributes. If the <code>attributes</code>
	 * parameter is null or empty then every object in the context is a match.
	 * </p>
	 * <p>
	 ...
	 * If parameter <code>as</code> is empty, no attributes are returned, but if
	 * <code>a</code>s is null all attributes are returned.
	 * </p>
	 * <p>
	 * The return value is an enumeration of <code>SearchResult</code> objects,
	 * which is empty if no matches are found. It is not specified how
	 * subsequent changes to context specified by <code>name</code> will affect
	 * an enumeration that this method returns.
	 * </p>
	 * <p>
	 * This method throws any <code>NamingException</code> that occurs.
	 * </p>
	...
	/**
	 * This method searches in the context specified by <code>name</code> only,
	 * using the filter specified by parameter <code>filter</code> and
	 ...
	 * arguments with types other than <code>String</code>. The result of giving
	 * invalid variable substitutions is not specified.
	 * </p>
	 * <p>
	 ...
	 * <code>name</code> will affect an enumeration that this method returns.
	 * </p>
	 * <p>
	 ...
	 * invalid this method will throw an
	 ...
	 * <code>InvalidSearchControlsException</code>, <code>NamingException</code>
	 * .
	 * </p>
	 * 
	 * @param name
