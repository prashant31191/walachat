...
public interface Resolver {
	...
	/**
	 * Partially resolves the name specified by name <code>n</code> stopping at
	 * the first context object which is of the <code>Context</code> subtype
