...
public interface InitialContextFactory {
	 ...
	 * be invoked. The specified <code>envmt</code> parameter may be null or may
	 * be used to customize the requested <code>Context</code> object. The
	 * implementation may clone or copy the <code>envmt</code> object, but will
