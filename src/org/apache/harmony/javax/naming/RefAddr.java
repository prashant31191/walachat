...
public abstract class RefAddr implements Serializable {
	 ...
	 * and the address contents are equivalent. *
	 * 
	 * @param o
	...
	public boolean equals(Object o) {
		if (o instanceof RefAddr) {
			final RefAddr a = (RefAddr) o;
			return addrType.equals(a.addrType)
					&& (null == getContent() ? null == a.getContent()
							: getContent().equals(a.getContent()));
		}
		return false;
	}
	...
	@Override
	public int hashCode() {
		return addrType.hashCode()
				+ (null == getContent() ? 0 : getContent().hashCode());
	}
