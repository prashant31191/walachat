 ...
 * safe when client code uses appropriate synchronization and locking.
 * </p>
 */
public class LinkException extends NamingException {
	...
	/**
	 * Sets the <code>linkRemainingName</code> to the specified name. It may be
	 * null. The remaining name details must not change even if the original
	 * <code>Name</code> itself changes.
	 * 
	 * @param name
	 *            the new <code>linkRemainingName</code> value to be set. It may
	 *            be null.
	 */
	...
	/**
	 * Sets the <code>linkResolvedName</code> to the specified name. This may be
	 * null. The resolved name details must not change even if the original
	 * <code>Name</code> itself changes.
	 * 
	 * @param name
