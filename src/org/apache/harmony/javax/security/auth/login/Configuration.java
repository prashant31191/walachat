...
public abstract class Configuration {
	...
	private static class InnerConfiguration extends Configuration {
		...
		public AppConfigurationEntry[] getAppConfigurationEntry(
			...
			return configurationSpi
					.engineGetAppConfigurationEntry(applicationName);
		}
	 ...
	 * active configuration was set to <code>null</code>, tries to load a
	 * default provider, so this method never returns <code>null</code>. <br>
	 ...
	 * most preferred Provider. A new Configuration object encapsulating the
	 ...
	 *             if no Provider supports a ConfigurationSpi implementation for
	 *             the specified type.
	...
	public static Configuration getInstance(String type,
			Configuration.Parameters params) throws NoSuchAlgorithmException {
	...
	public static Configuration getInstance(String type,
		...
		final Provider.Service service = provider.getService("Configuration",
				type);
		if (service == null) {
	 ...
	 *             if the specified provider is not registered in the provider
	 *             list
	 * 
	 * @since 1.6
	 */
	public static Configuration getInstance(String type,
			Configuration.Parameters params, String provider)
			throws NoSuchAlgorithmException, NoSuchProviderException {
		final Provider pro = Security.getProvider(provider);
	 ...
	 * 
	 * @return the type the parameter of this Configuration
	 */
	 ...
	 * 
	 * @return the type the provider of this Configuration
	 */
	public Provider getProvider() {
		return null;
	}
	 ...
	 * 
	 * @return the type the type of this Configuration
	 */
	public String getType() {
		return null;
	}
