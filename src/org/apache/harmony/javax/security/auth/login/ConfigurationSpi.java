 ...
 * org.apache.harmony.javax.security.auth.login.Configuration class.
 * 
 * If there is any class that wants to provide a Configuration implementation,
 * all abstract methods in this SPI should be implemented.
 * 
...
public abstract class ConfigurationSpi {
	...
	/**
	 * Refreshes/reloads the configuration. The behavior of this method depends
	 * on the implementation. For example, calling refresh on a file-based
	 * configuration will cause the file to be re-read.
	 * 
