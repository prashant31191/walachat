...
public class KerberosName extends GSSNameImpl {
	...
	public boolean equals(GSSName another) throws GSSException {
		...
		final KerberosName anotherNameImpl = (KerberosName) another;
		final String thisName = getName();
		final String anotherName = anotherNameImpl.getName();

		if (!thisName.equals(anotherName)) {
			return false;
		}

		final Oid thisOid = getStringNameType();
		final Oid anotherOid = anotherNameImpl.getStringNameType();
